...
const cityIndex = cityName.indexOf("y"); // Sostituisci la stringa con il codice
console.log(cityIndex + 1); // Output: 4 (l'indice parte da 0 quindi per avere un Output di 4 devo aggiungere 1..Andrea)
