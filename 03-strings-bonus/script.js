...
const cityIndex = city.indexOf("Y"); // Sostituisci la stringa con il codice
console.log(cityIndex); // Output: 4 (l'indice parte da 0 quindi per avere un Output di 4 devo aggiungere 1..Andrea)
